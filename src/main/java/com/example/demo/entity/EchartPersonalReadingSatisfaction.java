...
/**
 * echart个人阅读满意度
 * @TableName echart_personal_reading_satisfaction
 */
public class EchartPersonalReadingSatisfaction implements Serializable {
    /**
     * 唯一标识
     */
    private Integer id;
    ...
    public boolean equals(Object that) {
        ...
        EchartPersonalReadingSatisfaction other = (EchartPersonalReadingSatisfaction) that;
